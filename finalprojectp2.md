...
# Final Project Part II: Wireframes and Storyboards
## Wireframes
...
From these questions and work completed in the preliminary research stages, I was able to construct the forthcoming draft data visualizations. Notably, these visualizations are designed to be amenable to editing and reworking pending any story restructuring or eventual development of the Shorthand mood and theme following the collection of feedback.
...
After reviewing my storyboard, I drafted the following questions to ask my solicited participants:
  ...
  4. Is there anything else you would like to share with me about this story? Do any further questions arise from your engagement with the material?
...
The second interviewee noted their positive response to the representation of the presence of inequities facing non-native English speakers in every state. In talking to them on the phone following their submission of feedback, they were excited to be able to find Virginia on this graphic, as well as the graduation rate breakdown infographic. Similarly, the third interviewee noted that the graphics-heavy section in the first half of the report functioned well in showing the importance and scale of the issue at hand. I was also pleased to hear that all three participants enjoyed the color scheme; the data engineer pulled out the consistent assignment of color to language group and the two educators noted that the color scheme was aesthetically pleasing and not distracting to the data/story at hand. 

I found it interesting that both teachers noted that while the story is useful for teachers and higher-up decision makers in the education sphere, they both pinpointed staffing of instructors for ELs / ESOL (English as a Second Language) teachers as an intended audience member. I imagine this identification was born out of the fact that these specialized individuals are their primary points of contact for non-native language instruction in their place of employment. While these responses do indeed fit squarely in the scope of my intended audience, I would like to adapt the language of the body text slightly to explicitly address that ideological change should not **only** occur at the level of specialized instructors or policy makers, but rather start in the classroom and work up through every level of the educational system. Further, these responses will likely influence the resources I ultimately select for the final portion of the report that still needs to be fully fleshed out. 
...
Finally, all three participants snidely remarked via phone or text that they were "big fans" of and "extremely moved by" my To Be Determined STRONG CONCLUDING STATEMENT. I will certainly need to update them once the final product is complete. On the whole, the interviewees were quite unified in their opinions and general tone regarding the story's presentation and its encompassed visualizations. 
...
* Revise language to capture the importance of an ideological change in how English is regarded in schools **at all levels** of instruction and / or employment in relation to K-12 public education. 
...
After receiving this feedback, I am looking forward and highly motivated to complete the final section of this assignment in the coming week. 
